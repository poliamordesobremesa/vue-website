			...
			<div class="row">
				<div class="col-lg-4 me-auto mb-lg-0 mb-4 text-lg-start text-center">
					...
					<ul class="nav flex-row ms-n3 justify-content-lg-start justify-content-center mb-4 mt-sm-0">
						<li class="nav-item">
							<a class="nav-link text-dark opacity-8" href="https://www.creative-tim.com" target="_blank"> Home </a>
						</li>
						<li class="nav-item">
						...
						<li class="nav-item">
							<a class="nav-link text-dark opacity-8" href="https://www.creative-tim.com" target="_blank"> Services </a>
						</li>
					</ul>
					<p class="text-sm text-dark opacity-8 mb-0">
						Copyright © {{ new Date().getFullYear() }} Material Design by Creative Tim.
					</p>
				</div>
