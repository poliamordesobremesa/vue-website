			...
			<div class="row">
				<div class="row text-center my-sm-5 mt-5">
					<div class="col-lg-6 mx-auto">
						<MaterialBadge color="success" class="mb-3">Boost creativity</MaterialBadge>
		...
		<div class="container mt-5">
			<div class="row">
				<div class="col-md-8">
					...
					<div class="row mt-4">
						<div class="col-md-6 mt-md-0 mt-5">
							<ExampleCard classes="mt-5" title="Sign In Page" :image="imgSigninCover" route="signin-basic" />
						</div>
						<div class="col-md-6 mt-md-0 mt-5">
							<ExampleCard
								classes="shadow-lg"
				...
				<div class="col-md-3 mx-auto mt-md-0 mt-3">
					<div class="position-sticky" style="top: 100px !important">
						<h3>Presentation Pages for Company, Landing Pages, Blogs and Support</h3>
						<h6 class="text-secondary font-weight-normal">
							These is just a small selection of the multiple possibitilies you have. Focus on the business, not on the
							design.
						</h6>
					</div>
				</div>
