...
!(function (e, t) {
	...
	function m(e, n, o) {
		...
		return (
			(d || (!d && !o)) &&
				(('body' !== p(n) || h(v)) &&
					(y = (i = n) !== t(i) && r(i) ? { scrollLeft: (a = i).scrollLeft, scrollTop: a.scrollTop } : c(i)),
			...
			: V(
					(function (e) {
						var t,
							...
							p = -r.scrollTop;
						return (
							'rtl' === d(o || n).direction && (f += i(n.clientWidth, o ? o.clientWidth : 0) - a),
	...
	function te(e) {
		...
		if (l) {
			...
			if (
				...
				(M = E),
					(b -= (m && B === W && W.visualViewport ? W.visualViewport.height : B[H]) - o.height),
					(b *= p ? 1 : -1);
			if (i === A || ((i === j || i === E) && a === k))
