...
!(function (e, n) {
	...
	function y(g, h) {
				...
				(function (e) {
					...
					if (void 0 !== a.value && 2 === a.value.length) {
						...
						u < i
							...
							: u > l && ((u = a === D.hourElement ? u - l - r(!D.amPM) : i), g && Y(void 0, 1, D.hourElement)),
							D.amPM &&
								f &&
		...
		function Q(e, n) {
			...
			if (
				(D.config.minDate && t && C(t, D.config.minDate, void 0 !== n ? n : !D.minDateHasTime) < 0) ||
			...
			for (
				var a = D.config.enable.length > 0, i = a ? D.config.enable : D.config.disable, o = 0, r = void 0;
				o < i.length;
				o++
			) {
		...
		function ne(e) {
			...
			if (13 === e.keyCode && t) {
				if (a)
					return D.setDate(D._input.value, !0, n === D.altInput ? D.config.altFormat : D.config.dateFormat), n.blur();
				D.open();
			} else if (G(n) || i || o) {
		...
		function te(e) {
			if (
				...
				for (
					...
					Q(new Date(c), !0) ||
						((o = o || (c > a && c < i)), c < t && (!r || c > r) ? (r = c) : c > t && (!l || c < l) && (l = c));
		...
		function se(e) {
			...
			if (void 0 !== n) {
				var t = n,
					...
					i =
						(a.getMonth() < D.currentMonth || a.getMonth() > D.currentMonth + D.config.showMonths - 1) &&
						'range' !== D.config.mode;
		...
		(D.parseDate = b({ config: D.config, l10n: D.l10n })),
			...
			(D.clear = function (e, n) {
				...
				(D.selectedDates = []),
					...
					!0 === n && ((D.currentYear = D._initialDate.getFullYear()), (D.currentMonth = D._initialDate.getMonth()));
			...
			(D.destroy = function () {
				...
				if (((D._handlers = []), D.mobileInput))
					D.mobileInput.parentNode && D.mobileInput.parentNode.removeChild(D.mobileInput), (D.mobileInput = void 0);
			...
			(D.open = function (e, n) {
				...
				var a = D.isOpen;
				(D.isOpen = !0),
					a || (D.calendarContainer.classList.add('open'), D._input.classList.add('active'), ge('onOpen'), le(n));
		...
		function we(e) {
			void 0 === e && (e = !0),
				void 0 !== D.mobileInput &&
					D.mobileFormatStr &&
					(D.mobileInput.value =
						void 0 !== D.latestSelectedDateObj ? D.formatDate(D.latestSelectedDateObj, D.mobileFormatStr) : ''),
				...
				(D.element = D.input = g),
					...
					D.isMobile ||
						(function () {
										...
										Object.defineProperty(D, '_hidePrevMonthArrow', {
											...
											set: function (e) {
												D.__hidePrevMonthArrow !== e &&
													(d(D.prevMonthNav, 'flatpickr-disabled', e), (D.__hidePrevMonthArrow = e));
											},
										}),
										Object.defineProperty(D, '_hideNextMonthArrow', {
											...
											set: function (e) {
												D.__hideNextMonthArrow !== e &&
													(d(D.nextMonthNav, 'flatpickr-disabled', e), (D.__hideNextMonthArrow = e));
											},
										}),
									...
									(function () {
										...
										(D.minuteElement = t.getElementsByTagName('input')[0]),
											...
											(D.minuteElement.value = o(
												D.latestSelectedDateObj ? D.latestSelectedDateObj.getMinutes() : D.config.defaultMinute
											)),
										...
										if (D.config.enableSeconds) {
											...
											(D.secondElement = a.getElementsByTagName('input')[0]),
												(D.secondElement.value = o(
													D.latestSelectedDateObj ? D.latestSelectedDateObj.getSeconds() : D.config.defaultSeconds
												)),
										...
										D.config.time_24hr ||
											((D.amPM = s(
												'span',
												'flatpickr-am-pm',
												D.l10n.amPM[r((D.latestSelectedDateObj ? D.hourElement.value : D.config.defaultHour) > 11)]
											)),
							...
							if (
								...
								D.config.inline &&
									(!i && D.element.parentNode
										...
										: void 0 !== D.config.appendTo && D.config.appendTo.appendChild(D.calendarContainer)),
								D.config.static)
							) {
							...
							D.config.static ||
								D.config.inline ||
								(void 0 !== D.config.appendTo ? D.config.appendTo : window.document.body).appendChild(
									D.calendarContainer
								);
						})(),
					(function () {
						...
						F(window.document, 'focus', V, { capture: !0 }),
							!0 === D.config.clickOpens && (F(D._input, 'focus', D.open), F(D._input, 'click', D.open));
						void 0 !== D.daysContainer &&
							(F(D.monthNav, 'click', be), F(D.monthNav, ['keyup', 'increment'], O), F(D.daysContainer, 'click', se));
					...
					(D.selectedDates.length || D.config.noCalendar) &&
						(D.config.enableTime && I(D.config.noCalendar ? D.latestSelectedDateObj || D.config.minDate : void 0),
						we(!1)),
					x();
