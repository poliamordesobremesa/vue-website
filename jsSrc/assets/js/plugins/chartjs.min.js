...
!(function (t, e) {
			...
			const o = Re(t.options.layout.padding),
				...
				r = (function (t) {
					const e = (function (t) {
							...
							for (i = 0, n = (t || []).length; i < n; ++i)
								(o = t[i]),
									e.push({ index: i, box: o, pos: o.position, horizontal: o.isHorizontal(), weight: o.weight });
							return e;
						})(t),
						i = We(
		...
		acquireContext(t, e) {
			...
			return i && i.canvas === t
				? ((function (t, e) {
						...
						if (
							((t.$chartjs = {
								initial: { height: n, width: o, style: { display: i.display, height: i.height, width: i.width } },
							}),
	...
	const hi = (t) => 0 === t || 1 === t,
		...
		ui = (t, e, i) => Math.pow(2, -10 * t) * Math.sin(((t - e) * bt) / i) + 1,
			...
			easeInOutExpo: (t) =>
				hi(t) ? t : t < 0.5 ? 0.5 * Math.pow(2, 10 * (2 * t - 1)) : 0.5 * (2 - Math.pow(2, -10 * (2 * t - 1))),
	...
	class Ai {
		...
		_dataCheck() {
			...
			U(i)
				...
				: t._data !== i &&
				  (t._data && (re(t._data, t), Pi(t._cachedMeta)), i && Object.isExtensible(i) && ae(i, t), (t._data = i));
		}
		addElements() {
			const t = this,
				e = t._cachedMeta;
	...
	class ji extends Oi {
		...
		update(t, e, i) {
			...
			n.beforeUpdate(),
				...
				n._dataLimitsCached ||
					(n.beforeDataLimits(), n.determineDataLimits(), n.afterDataLimits(), (n._dataLimitsCached = !0)),
				n.beforeBuildTicks(),
		...
		getContext(t) {
			...
			return (
				e.$context ||
				(e.$context =
					((n = e.chart.getContext()), (o = e), Object.assign(Object.create(n), { scale: o, type: 'scale' })))
			);
			var n, o;
		}
		_tickSize() {
	...
	class Yn {
		constructor(t, e) {
			...
			if (s)
				throw new Error(
					"Canvas is already in use. Chart with ID '" + s.id + "' must be destroyed before the canvas can be reused."
				);
		...
		_handleEvent(t, e) {
			...
			return (
				'mouseout' !== t.type &&
					((r = i.getElementsAtEventForMode(t, s.mode, s, a)), (c = 'click' === t.type ? i._lastEvent : t)),
				(i._lastEvent = null),
				Q(o.onHover, [t, r, i], i),
	...
	class eo extends Ai {
		...
		_getStacks(t, e) {
			...
			for (r = 0; r < s; ++r) {
				...
				if (
					((!1 === o || -1 === a.indexOf(l.stack) || (void 0 === o && void 0 === l.stack)) && a.push(l.stack),
					l.index === t)
				)
					break;
			}
			...
			let { start: r, count: l } = (function (t, e, i) {
				...
				if (t._sorted) {
					...
					d && (o = Ht(Math.min(ie(r, a.axis, c).lo, i ? n : ie(e, l, a.getPixelForValue(c)).lo), 0, n - 1)),
						(s = u
							? Ht(Math.max(ie(r, a.axis, h).hi + 1, i ? 0 : ie(e, l, a.getPixelForValue(h)).hi + 1), o, n) - o
							: n - o);
				}
	...
	function So(t) {
		...
		const i = {};
		return e
			? ((e = t.horizontal ? Po(e, 'left', 'right', t.base > t.x) : Po(e, 'bottom', 'top', t.base < t.y)),
			  (i[e] = !0),
			  i)
			: i;
	}
	...
	class Ro extends Oi {
		...
		draw(t) {
			...
			t.save(),
				(n.w === i.w && n.h === i.h) ||
					(t.beginPath(), o(t, n), t.clip(), o(t, i), (t.fillStyle = e.borderColor), t.fill('evenodd')),
				t.beginPath(),
				o(t, i),
		...
		_fitCols(t, e, i, n) {
			...
			return (
				o.legendItems.forEach((t, o) => {
					...
					o > 0 &&
						f + e + 2 * r > h &&
						((d += u + r), c.push({ width: u, height: f }), (g += u + r), m++, (p = 0), (u = f = 0)),
						(u = Math.max(u, a)),
						(f += e + r),
	...
	class _s extends ji {
		...
		parse(t, e) {
			...
			return ((t, e) =>
				null === t
					? null
					: Ht(Math.round(t), 0, e))((e = isFinite(e) && i[e] === t ? e : bs(i, t, K(e, t))), i.length - 1);
		}
		determineDataLimits() {
			const t = this,
	...
	class ys extends ji {
		...
		buildTicks() {
			...
			const o = (function (t, e) {
				...
				let v = 0;
				for (
					f && (i.push({ value: o }), x <= o && v++, Ot(Math.round((x + v * y) * m) / m, o, y / 10) && v++);
					v < _;
					++v
				)
				...
				{ maxTicks: n, min: e.min, max: e.max, precision: i.precision, step: i.stepSize, count: i.count },
				Fe(t, e.grace)
			);
			return (
	...
	function Es(t, e) {
		...
		return (
			...
			null === r
				? null
				: (s && (r = 'week' !== s || (!At(a) && !0 !== a) ? i.startOf(r, s) : i.startOf(r, 'isoWeek', a)), +r)
		);
	}
	function Is(t, e, i, n) {
		const o = Ls.length;
