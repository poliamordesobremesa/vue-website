	...
	var e = {
		...
		i = function (e, t, n) {
			0 === e && document.body.focus(),
				n ||
					(e.focus(),
					document.activeElement !== e && (e.setAttribute('tabindex', '-1'), e.focus(), (e.style.outline = 'none')),
					window.scrollTo(0, t));
		},
		r = function (e, t, n, o) {
				...
				if (h || p) {
						...
						A = function (e) {
							g || (g = e),
								...
								(function (e, t) {
									...
									if (e == t || o == t || (w < t && window.innerHeight + o) >= O)
										return m.cancelScroll(!0), i(n, t, h), r('scrollStop', l, n, s), (g = null), (f = null), !0;
					...
					0 === window.pageYOffset && window.scrollTo(0, 0),
						...
						'matchMedia' in window && window.matchMedia('(prefers-reduced-motion)').matches
							? i(n, Math.floor(E), !1)
							: (r('scrollStart', l, n, s), m.cancelScroll(!0), window.requestAnimationFrame(A));
				}
			});
		var h = function (e) {
				if (
							...
							if (history.replaceState && e.updateURL && !history.state) {
								...
								(t = t || ''),
									history.replaceState(
										{ smoothScroll: JSON.stringify(e), anchor: t || window.pageYOffset },
										document.title,
			...
			p = function () {
				if (null !== history.state && history.state.smoothScroll && history.state.smoothScroll === JSON.stringify(u)) {
					...
					('string' == typeof e && e && !(e = document.querySelector(n(history.state.anchor)))) ||
		...
		return (
			(function () {
				...
				m.destroy(),
					...
					u.updateURL && u.popstate && window.addEventListener('popstate', p, !1);
			})(),
			m
		);
	};
