	...
	function m(a) {
		...
		function h(a) {
			...
			q > k && q < h
				...
				: (q <= k && 0 !== O && (d(0), p && g()), q >= h && O !== h && (d(h), p || g()));
			a >= h &&
				(f.remaining
					? ((t = n), 'alternate' === f.direction && (f.reversed = !f.reversed))
					: (f.pause(), P(), (Q = b()), f.completed || ((f.completed = !0), e('complete'))),
				(l = 0));
		...
		x = (function () {
			...
			return function (b, c, d, e) {
				if (0 <= b && 1 >= b && 0 <= d && 1 >= d) {
					...
					if (b !== c || d !== e) for (var h = 0; 11 > h; ++h) g[h] = a(0.1 * h, b, d);
					return function (h) {
						if (b === c && d === e) return h;
						if (0 === h) return 0;
						if (1 === h) return 1;
						...
						if (0.001 <= n) {
							...
							var l = k,
								k = k + 0.1,
								f = 0;
							do (m = l + (k - l) / 2), (n = a(m, b, d) - h), 0 < n ? (k = m) : (l = m);
