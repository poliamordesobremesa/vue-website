...
var hljs = (function () {
	...
	const u = /\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./,
		...
		w = (e, t, n = {}) => {
			...
			return (
				i.contains.push(v),
				i.contains.push({ className: 'doctag', begin: '(?:TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):', relevance: 0 }),
				i
			);
		},
		y = w('//', '$'),
	...
	var _ = Object.freeze({
		...
		SHEBANG: (e = {}) => {
			const t = /^#![ ]*\//;
			return (
				e.binary && (e.begin = ((...e) => e.map((e) => g(e)).join(''))(t, /.*\b/, e.binary, /\b.*/)),
				a(
					{
						className: 'meta',
						begin: t,
	...
	function T(e, { plugins: t }) {
		...
		return (
			...
			(function t(i, r) {
				...
				let o = null;
				if (
					('object' == typeof i.keywords && ((o = i.keywords.$pattern), delete i.keywords.$pattern),
	...
	return ((e) => {
		...
		function f(e, t, s, l) {
				...
				if (((E = a), 'begin' === a.type))
					return (function (e) {
						...
						return (
							...
							n.skip ? (M += t) : (n.excludeBegin && (M += t), g(), n.returnBegin || n.excludeBegin || (M = t)),
							h(n),
			...
			try {
				...
				if (r) return { illegal: !1, relevance: 0, value: G(t), emitter: k, language: e, top: R, errorRaised: n };
				throw n;
			}
		}
		function p(e, t) {
			...
			const i = ((e) => {
					const t = { relevance: 0, emitter: new u.__emitter(u), value: G(e), illegal: !1, top: g };
		...
		function x(e) {
			...
			const n = ((e) => {
				...
				if (n) {
					const t = N(n[1]);
					return (
						t || (z(o.replace('{}', n[1])), z('Falling back to no-highlight mode for this block.', e)),
						t ? n[1] : 'no-highlight'
					);
				}
...
hljs.registerLanguage(
	...
	(() => {
		'use strict';
		function e(e) {
			return ((...e) => e.map((e) => ((e) => (e ? ('string' == typeof e ? e : e.source) : null))(e)).join(''))(
				'(',
				e,
				')?'
			);
		...
		return (r) => {
			...
			const l = r.inherit(r.TITLE_MODE, { begin: s }),
				...
				g = {
					...
					begin: '\\([^\\(]',
					returnBegin: !0,
					contains: [{ begin: /\(/, end: /\)/, keywords: t, contains: ['self'].concat(c) }],
				};
			return {
				name: 'CoffeeScript',
				...
				contains: c.concat([
					...
					},
					{
						begin: /[:\(,=]\s*/,
						relevance: 0,
						contains: [{ className: 'function', begin: d, end: '[-=]>', returnBegin: !0, contains: [g] }],
					},
					{
						className: 'class',
						beginKeywords: 'class',
				...
				contains: [
					...
					},
					{
						...
						contains: [
							...
							{ begin: e.IDENT_RE + '\\s*(<.+>\\s*)?\\(', returnBegin: !0, contains: [e.TITLE_MODE, E], relevance: 0 },
							{
								className: 'params',
								begin: /\(/,
								end: /\)/,
			...
			return {
				...
				contains: [
					...
					},
					{
						begin:
							((s = /@/),
							((...e) => e.map((e) => ((e) => (e ? ('string' == typeof e ? e : e.source) : null))(e)).join(''))(
								'(?=',
								s,
								')'
							)),
	...
	(() => {
		...
		return (s) => {
			...
			const t = {
				...
				c = { begin: /\[/, end: /\]/, contains: [i, r, t, l, a, 'self'], relevance: 0 },
	...
	(() => {
		...
		return (i) => {
			const c = e,
				...
				E = { className: 'subst', begin: '\\$\\{', end: '\\}', keywords: l, contains: [] },
				u = {
					begin: 'html`',
					end: '',
					starts: { end: '`', returnEnd: !1, contains: [i.BACKSLASH_ESCAPE, E], subLanguage: 'xml' },
				},
				_ = {
					begin: 'css`',
					end: '',
					starts: { end: '`', returnEnd: !1, contains: [i.BACKSLASH_ESCAPE, E], subLanguage: 'css' },
				},
				m = { className: 'string', begin: '`', end: '`', contains: [i.BACKSLASH_ESCAPE, E] },
				y = {
					className: 'comment',
					variants: [
						i.COMMENT(/\/\*\*(?!\/)/, '\\*/', {
			...
			const A = [].concat(y, E.contains),
				f = A.concat([{ begin: /\(/, end: /\)/, keywords: l, contains: ['self'].concat(A) }]),
				p = { className: 'params', begin: /\(/, end: /\)/, excludeBegin: !0, excludeEnd: !0, keywords: l, contains: f };
			return {
				name: 'Javascript',
	...
	(() => {
		...
		return (n) => {
			const e = {
				...
				s = { begin: '\\[', end: '\\]', contains: [n.inherit(l)], illegal: '\\S' };
			return (
				a.push(t, s),
				i.forEach((n) => {
					a.push(n);
	...
	(() => {
		...
		return (a) => {
			...
			const f = g.concat({ begin: /\{/, end: /\}/, contains: c }),
				...
				E = { begin: `[\\w-]+:(:)?(${l.join('|')})`, returnBegin: !0, contains: [k] };
			return (
	...
	(() => {
		...
		return (e) => {
			const t = '\\[=*\\[',
				...
				o = [e.COMMENT('--(?!\\[=*\\[)', '$'), e.COMMENT('--\\[=*\\[', a, { contains: [n], relevance: 10 })];
			return {
				name: 'Lua',
				keywords: {
	...
	(() => {
		...
		return (e) => {
			const t = a(/[A-Z_]/, a('(', /[A-Z0-9_.-]*:/, ')?'), /[A-Z0-9_.-]*/),
				...
				r = { begin: /\s/, contains: [{ className: 'meta-keyword', begin: /#?[a-z_][a-z1-9_-]+/, illegal: /\n/ }] },
				...
				contains: [
					{
						...
						contains: [
							...
							c,
							{
								...
								contains: [{ className: 'meta', begin: /<![a-z]/, end: />/, contains: [r, c, g, l] }],
							},
						],
					},
					e.COMMENT(/<!--/, /-->/, {
...
hljs.registerLanguage(
	...
	(() => {
		...
		return (e) => {
			...
			return (i.contains = p), (a.contains = p), { name: 'Perl', aliases: ['pl', 'pm'], keywords: s, contains: p };
		};
	})()
);
hljs.registerLanguage(
			...
			const n = {
				...
				t = {
					...
					variants: [
						...
						{ begin: /([fF][rR]|[rR][fF]|[fF])"""/, end: /"""/, contains: [e.BACKSLASH_ESCAPE, a, s, i] },
				...
				compilerExtensions: [
					(a, n) => {
						...
						Object.keys(a).forEach((e) => {
							...
							(a.starts = { relevance: 0, contains: [Object.assign(i, { endsParent: !0 })] }),
							(a.relevance = 0),
	...
	(() => {
		...
		return (n) => {
			const a = '([a-zA-Z_]\\w*[!?=]?|[-+~]@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?)',
					...
					variants: [
						...
						{ begin: /\B\?\\?\S/ },
						{
							...
							contains: [
								...
								n.END_SAME_AS_BEGIN({ begin: /(\w+)/, end: /(\w+)/, contains: [n.BACKSLASH_ESCAPE, c] }),
							],
						},
					],
				},
				...
				l = { className: 'params', begin: '\\(', end: '\\)', endsParent: !0, keywords: i },
				o = [
					t,
					{
						className: 'class',
					...
					{ className: 'symbol', begin: ':(?!\\s)', contains: [t, { begin: a }], relevance: 0 },
					d,
	...
	(() => {
		...
		return (e) => {
			...
			return {
				...
				contains: [
					{ begin: t(...o), keywords: { $pattern: /[\w\.]+/, keyword: l.concat(o), literal: a, type: i } },
					{ className: 'type', begin: t('double precision', 'large object', 'with timezone', 'without timezone') },
					u,
	...
	(() => {
		...
		return (e) => {
			const p = { match: /\s+/, relevance: 0 },
				...
				N = { className: 'keyword', begin: a(/\./, n(t(...s, ...u))), end: t(...s, ...u), excludeBegin: !0 },
				A = {
					match: a(/\./, t(...r)),
					relevance: 0,
				},
				...
				k = [
					...
					{ className: 'built_in', match: a(/\b/, t(...d), /(?=\()/) },
				],
				M = { match: /->/, relevance: 0 },
				S = [
					M,
				...
				T = (e = '') => ({ className: 'subst', match: a(/\\/, e, /[\t ]*(?:[\r\n]|\r\n)/) }),
				L = (e = '') => ({ className: 'subst', label: 'interpol', begin: a(/\\/, e, /\(/), end: /\)/ }),
				P = (e = '') => ({ begin: a(e, /"""/), end: a(/"""/, e), contains: [O(e), T(e), L(e)] }),
				$ = (e = '') => ({ begin: a(e, /"/), end: a(/"/, e), contains: [O(e), L(e)] }),
				K = { className: 'string', variants: [P(), P('#'), P('##'), P('###'), $(), $('#'), $('##'), $('###')] },
				j = {
					match: a(/`/, w, /`/),
				},
				z = [
				...
				q = [
					{
						match: /(@|#)available/,
						className: 'keyword',
						starts: { contains: [{ begin: /\(/, end: /\)/, keywords: E, contains: [...S, I, K] }] },
					},
			...
			const G = {
				...
				Q = {
					...
					contains: [
						...
						{ begin: /{/, end: /}/, relevance: 0, endsParent: !0, keywords: [...l, ...o], contains: [U] },
					],
				};
			for (const e of K.variants) {
				...
				n.keywords = D;
				const a = [...B, ...k, ...S, I, K, ...z];
				n.contains = [...a, { begin: /\(/, end: /\)/, contains: ['self', ...a] }];
			}
			return {
				name: 'Swift',
				keywords: D,
	...
	(() => {
		...
		return (i) => {
			const c = {
				...
				b = ((i) => {
					const c = e,
						...
						u = { className: 'subst', begin: '\\$\\{', end: '\\}', keywords: l, contains: [] },
						E = {
							begin: 'html`',
							end: '',
							starts: { end: '`', returnEnd: !1, contains: [i.BACKSLASH_ESCAPE, u], subLanguage: 'xml' },
						},
						m = {
							begin: 'css`',
							end: '',
							starts: { end: '`', returnEnd: !1, contains: [i.BACKSLASH_ESCAPE, u], subLanguage: 'css' },
						},
						y = { className: 'string', begin: '`', end: '`', contains: [i.BACKSLASH_ESCAPE, u] },
						_ = {
							className: 'comment',
							variants: [
								i.COMMENT(/\/\*\*(?!\/)/, '\\*/', {
					...
					const N = [].concat(_, u.contains),
						f = N.concat([{ begin: /\(/, end: /\)/, keywords: l, contains: ['self'].concat(N) }]),
						A = {
							className: 'params',
							begin: /\(/,
							end: /\)/,
					...
					return {
						...
						contains: [
							...
							g,
							{
								begin: r(/[{,\n]\s*/, t(r(/(((\/\/.*$)|(\/\*(\*[^/]|[^*])*\*\/))\s*)*/, c + '\\s*:'))),
								relevance: 0,
								contains: [{ className: 'attr', begin: c + t('\\s*:'), relevance: 0 }],
							},
							{
								begin: '(' + i.RE_STARTERS_RE + '|\\b(case|return|throw)\\b)\\s*',
								keywords: 'return throw case',
			...
			return (
				...
				l(b, 'use_strict', { className: 'meta', relevance: 10, begin: /^\s*['"]use strict['"]/ }),
	...
	(() => {
		...
		return (e) => {
			var n = 'true false yes no null',
				...
				r = [...b];
			return (
				r.pop(), r.push(i), (l.contains = r), { name: 'YAML', case_insensitive: !0, aliases: ['yml'], contains: b }
			);
		};
	})()
);
