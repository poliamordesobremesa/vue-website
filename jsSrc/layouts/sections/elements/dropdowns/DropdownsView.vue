...
<template>
	<BaseLayout title="Dropdowns" :breadcrumb="[{ label: 'Elements', route: '#' }, { label: 'Dropdowns' }]">
		<View title="Dropdown and Dropup" :code="dropdownAndDropupCode" id="dropdown-dropup">
			<DropdownAndDropup />
		</View>
	</BaseLayout>
</template>
