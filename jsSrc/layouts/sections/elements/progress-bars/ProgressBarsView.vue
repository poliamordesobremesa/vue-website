...
<template>
	<BaseLayout title="Progress Bars" :breadcrumb="[{ label: 'Elements', route: '#' }, { label: 'Progress Bars' }]">
		<View title="Progress Bars Simple" :code="progressSimpleCode" id="progress-simple">
			<ProgressSimple />
		</View>
	</BaseLayout>
</template>
