...
<template>
	<BaseLayout title="Pagination" :breadcrumb="[{ label: 'Navigation', route: '#' }, { label: 'Pagination' }]">
		<View title="Pagination Simple" :code="paginationSimpleCode" id="pagination-simple">
			<PaginationSimple />
		</View>
	</BaseLayout>
</template>
